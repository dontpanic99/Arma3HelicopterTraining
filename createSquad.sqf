...
posMan = createVehicle ["vn_b_men_sog_23",_lzLocation];
...
private _groupTaxi = createGroup west;
    ...
    if (_cargoSeats > 8) then
    {
		...
		_sog13 = _groupTaxi createUnit ["vn_b_men_sog_23", [0, 0, 0], [], 0, "NONE"];
...
deleteVehicle posMan;
    ...
    {
		_sog16 = _groupTaxi createUnit ["vn_b_men_sog_06", [0, 0, 0], [], 0, "NONE"]; 
    ...
    {
        	_sog05 = _groupTaxi createUnit ["vn_b_men_sog_27", [0, 0, 0], [], 0, "NONE"];
