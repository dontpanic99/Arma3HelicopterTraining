...
"vn_o_men_nva_01" createUnit [_enemyPosition, _groupEnemy,"",0.6, "CORPORAL"];
"vn_o_men_nva_11" createUnit [_enemyPosition, _groupEnemy,"",0.1, "PRIVATE"];
"vn_o_men_nva_11" createUnit [_enemyPosition, _groupEnemy,"",0.3, "PRIVATE"];
"vn_o_men_nva_11" createUnit [_enemyPosition, _groupEnemy,"",0.3, "PRIVATE"];
"vn_o_men_nva_11" createUnit [_enemyPosition, _groupEnemy,"",0.3, "PRIVATE"];
"vn_o_men_nva_11" createUnit [_enemyPosition, _groupEnemy,"",0.3, "PRIVATE"];
"vn_o_men_nva_05" createUnit [_enemyPosition, _groupEnemy,"",0.3, "PRIVATE"];
"vn_o_men_nva_05" createUnit [_enemyPosition, _groupEnemy,"",0.3, "PRIVATE"];
"vn_o_men_nva_05" createUnit [_enemyPosition, _groupEnemy,"",0.3, "PRIVATE"];
"vn_o_men_nva_05" createUnit [_enemyPosition, _groupEnemy,"",0.3, "PRIVATE"];
"vn_o_men_nva_05" createUnit [_enemyPosition, _groupEnemy,"",0.3, "PRIVATE"];
...
if (_includeAA) then
{
    "vn_o_men_nva_43" createUnit [_enemyPosition, _groupEnemy,"",0.75, "CORPORAL"];
};
