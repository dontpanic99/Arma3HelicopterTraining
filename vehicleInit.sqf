...
[_vehicle, ["<t color='#FFFF00'>Repair vehicle</t>", { _this remoteExec ["xenoRepair", _this select 0]; },nil,0.19,true,true,"","true",5,false,"",""]] remoteExec ["addAction", 0, "addrepair" + (_vehicle call BIS_fnc_netId)];
...
[_vehicle, ["<t color='#FF0000'>Destroy vehicle</t>", { _this remoteExec ["destroyVehicleAction", _this select 0]; },nil,0.05,true,true,"","true",5,false,"",""]] remoteExec ["addAction", 0, "destroy" + (_vehicle call BIS_fnc_netId)];
